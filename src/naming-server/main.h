...
FileEntry* insert_path_forc(const char *path, int *storage_server_ids, int num_chosen, TrieNode *root);
FileEntry* insert_path_forss(const char *path, int *storage_server_ids, int num_chosen, TrieNode *root);
